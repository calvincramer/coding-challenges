...
class Solution(object):
    ...
    def maxSubArray(self, nums):
        # Credit to: https://leetcode.com/problems/maximum-subarray/discuss/20193/DP-solution-and-some-thoughts
        dp = [0] * len(nums)
        dp[0] = nums[0]
        m = nums[0]
