...
impl crate::Problem for P073 {
    ...
    fn problem_num(&self) -> i32 { 73 }
    fn answer_desc(&self) -> String { "num fractions".to_string() }
    fn real_answer(&self) -> crate::ProblemAnswer { crate::ProblemAnswer::Some("7295372".to_string()) }
}
