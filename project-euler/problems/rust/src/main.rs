...
mod p080; mod p081; mod p082; mod p083; mod p084; mod p085; mod p086;
...
fn timed_run(prob: &dyn Problem, verbose: bool, skip_slow: bool) {
    ...
    let answer_str = if skip_run { "    SKIP SLOW".to_string() } else { prob.solve(verbose) };
...
fn run_all_problems(verbose: bool, skip_slow: bool) {
    let problems: Vec<&dyn Problem> = vec![
        ...
        &p005::P005{}, &p006::P006{}, &p007::P007{}, &p008::P008{}, &p009::P009{},
        &p010::P010{}, &p011::P011{}, &p012::P012{}, &p013::P013{}, &p014::P014{},
        &p015::P015{}, &p016::P016{}, &p017::P017{}, &p018::P018{}, &p019::P019{},
        &p020::P020{}, &p021::P021{}, &p022::P022{}, &p023::P023{}, &p024::P024{},
        &p025::P025{}, &p026::P026{}, &p027::P027{}, &p028::P028{}, &p029::P029{},
        &p030::P030{}, &p031::P031{}, &p032::P032{}, &p033::P033{}, &p034::P034{},
        &p035::P035{}, &p036::P036{}, &p037::P037{}, &p038::P038{}, &p039::P039{},
        &p040::P040{}, &p041::P041{}, &p042::P042{}, &p043::P043{}, &p044::P044{},
        &p045::P045{}, &p046::P046{}, &p047::P047{}, &p048::P048{}, &p049::P049{},
        &p050::P050{}, &p051::P051{}, &p052::P052{}, &p053::P053{}, &p054::P054{},
        &p055::P055{}, &p056::P056{}, &p057::P057{}, &p058::P058{}, &p059::P059{},
        &p060::P060{}, &p061::P061{}, &p062::P062{}, &p063::P063{}, &p064::P064{},
