...
mod p070; mod p071; mod p072; mod p073; mod p074; mod p075; mod p076; mod p077;
...
fn run_problems() {
    ...
    // timed_run(&p067::P067{}, false);
    // timed_run(&p068::P068{}, false);
    // timed_run(&p069::P069{}, false);
    // // timed_run(&p070::P070{}, false);    // Slow
    // timed_run(&p071::P071{}, false);
    // timed_run(&p072::P072{}, false);
    // timed_run(&p073::P073{}, false);
    // timed_run(&p074::P074{}, false);
    // timed_run(&p075::P075{}, false);
    // timed_run(&p076::P076{}, false);
    timed_run(&p077::P077{}, false);
}
