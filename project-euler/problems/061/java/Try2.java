                ...
                for (int i2 = 00; i2 <= 99; i2++) {
                    ...
                    for (int i3 = 00; i3 <= 99; i3++) {
                        ...
                        for (int i4 = 00; i4 <= 99; i4++) {
                            ...
                            if (skip)
                                continue;
                            //check to see if grid has unique solution (every row and column has exactly one found)
                            //numbers (rows)
                            boolean good = true;
